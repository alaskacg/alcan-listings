...
import { ArrowRight, DollarSign, Clock, ImageIcon } from "lucide-react";
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-6">
            Ready to Sell? Post Your Listing Today
          </h2>
          
          <p className="text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
            Reach thousands of Interior Alaskans looking for exactly what you're selling. Post your listing with a verified email!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-glass rounded-2xl p-6 text-center">
              ...
              <p className="text-muted-foreground text-sm">Per listing with verified email</p>
            </div>
            ...
            <div className="bg-glass rounded-2xl p-6 text-center">
              ...
              <p className="text-muted-foreground text-sm">Each listing stays active for 60 days</p>
            </div>
